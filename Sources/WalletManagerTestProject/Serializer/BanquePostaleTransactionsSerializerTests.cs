...
namespace WalletManagerTestProject.Serializer
{
    public class BanquePostaleTransactionsSerializerTests
    {
        ...
        public BanquePostaleTransactionsSerializerTests()
        {
            ...
            _contentFile = _contentFile.Append("16-Jun-20 12:36:14 AM;\"VIREMENT POUR WATTIER COMPTE FR76182060040819811126001 LOYER\";-680,00;-4460,51");
            _contentFile = _contentFile.Append("16-Jun-20 12:36:14 AM;\"VIREMENT DE MME   NATHALIA ROHEE Virement de MME NATHALIA ROHEE REFERENCE: 0190248000073017 \";850,00;5575,63");
        }
